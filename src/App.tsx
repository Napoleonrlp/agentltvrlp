import './App.css'; // ✅ Ensures App.css styles (.input etc.) are applied
  ...
  return (
    <div className="min-h-screen bg-[var(--rlp-light)] py-10 px-4 flex justify-center items-start">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-6 sm:p-10 border border-gray-200">
        <h2 className="text-3xl sm:text-4xl font-bold text-center text-[var(--rlp-red)] mb-8">Agent LTV Calculator</h2>
        ...
        <div className="mt-8">
          <h3 className="font-semibold text-lg text-[var(--rlp-red)] mb-4">Optional Revenue Sources:</h3>
        ...
        <div className="mt-12 p-6 border-4 border-[var(--rlp-red)] rounded-xl bg-white shadow-lg text-center">
          <h4 className="text-xl sm:text-2xl font-bold text-[var(--rlp-red)] mb-2 uppercase tracking-wide">Estimated Lifetime Value (LTV) to RLP</h4>
